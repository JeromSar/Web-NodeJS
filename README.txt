...
web server. This information includes all request and response information. If you
have logging enabled in config.ini, all info will be written to log.txt exactly as
